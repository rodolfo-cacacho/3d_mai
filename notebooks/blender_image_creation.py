...
cwd = '/Users/rodolfocacacho/Documents/Documents/MAI/Project module/3d_mai/notebooks/'
os.chdir(cwd)
cwd = os.getcwd()
print(cwd)
...
#    # Set material properties for a metal-like appearance
...
#    # Set shader properties for a metal-like appearance
#    principled_bsdf.inputs["Base Color"].default_value = (0.8, 0.8, 0.8, 1)  # Steel color
#    principled_bsdf.inputs["Metallic"].default_value = 0.80  # Full metalness
##    principled_bsdf.inputs["Specular"].default_value = 0.5  # Adjust to control reflectivity

#    # Optional: Adjust other properties such as Roughness, Clearcoat, etc.
